...
import { fetchCurrentUser, updateUserProfile } from "@/store/User/authSlice";
...
export default function ProfilePage() {
  ...
  return (
    <div className="container mx-auto py-4 flex flex-col gap-2">
      <div className="w-full flex justify-between items-center mb-3 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">
          Profile Settings
        </h2>
        <Button
          onClick={() => setIsEditing(!isEditing)}
          className={`transition-colors duration-300 ease-in-out px-4 py-2 text-white font-medium rounded-lg shadow-md ${
            isEditing
      ...
      {isEditing ? (
        <>
          <h1 className="text-3xl font-bold mb-3">Edit Profile Information</h1>
            ...
            <Form {...form}>
              ...
              >
                <TabsContent value="personal">
                  <Card className="border-none h-[55vh]">
                    <CardHeader>
