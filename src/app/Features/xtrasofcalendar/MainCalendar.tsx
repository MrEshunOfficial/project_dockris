...
import { selectFilteredTodos } from "@/store/scheduleSlice/todoSlice";
import { selectAppointments } from "@/store/scheduleSlice/appointmentSlice";
import { selectAllEvents } from "@/store/scheduleSlice/eventSlice";
...
const MainCalendar: React.FC<CalendarProps> = ({
  ...
  const events = [
    ...
    ...appointments.map((appointment) => ({
      ...
      start: moment(appointment.dueDateTime).format("HH:mm a"),
