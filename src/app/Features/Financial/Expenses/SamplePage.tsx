...
// Zod schema for Expense form data (using string for IDs)
...
const SamplePage: React.FC<ExpenseFormProps> = ({ expenseToEdit, onClose }) => {
  ...
  useEffect(() => {
    ...
    if (expenseToEdit) {
      Object.keys(expenseToEdit).forEach((key) => {
        ...
        // Convert Mongoose ObjectId to string for form handling
  ...
  const renderSubExpenses = () => (
    <div className="flex flex-col gap-3 p-1 w-3/4">
      ...
      <ScrollArea className="w-full h-[50vh]">
        {fields.map((field, index) => (
          <div
            key={field.id}
            className="flex flex-col gap-3 p-2 w-3/4 border border-gray-300 dark:border-gray-600 rounded-lg my-2"
          >
    ...
    switch (currentPage) {
      ...
      case 3:
        return (
          <div className="flex flex-col gap-3 p-1 w-3/4">
            <p className="text-center w-full p-1 border-b border-gray-300 dark:border-gray-600 mb-2">
              {expenseToEdit?.name || "Attachment and more... "}
            </p>
            <div>
              <Label
                htmlFor="attachments"
  ...
  return (
    <div className="w-full h-full flex flex-col gap-2 p-1">
      <form
        ...
        className="flex-1 flex flex-col gap-2 w-full bg-gray-50 dark:bg-gray-900"
      >
        {/* Main Content */}
        <section className="flex-1 h-full flex items-center justify-center gap-2">
          {/* Left Column - Basic Info */}
          <div className="flex-1 h-full flex flex-col overflow-auto gap-2 p-1 items-center justify-start border border-gray-300 dark:border-gray-600 rounded-lg">
            <header className="h-auto mb-2 w-full flex flex-col items-center justify-between p-3">
              ...
              <p className="w-full text-gray-500 mt-2">
                {expenseToEdit
        ...
        <CardFooter className="h-auto flex flex-col gap-2">
          <Pagination>
            <PaginationContent>
              <PaginationItem>
                <PaginationPrevious
